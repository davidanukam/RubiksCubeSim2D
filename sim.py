...
def Sim():
    ...
    icon = pg.image.load(resource_path("assets/RubiksCubeLogo.png"))
    ...
    while running:
        for event in pg.event.get():
            ...
            if event.type == pg.KEYDOWN:
                ...
                current_key_map = MOVE_MAPPING.get(mod_combo, {})

                if event.key in current_key_map:
                    moves.append(current_key_map[event.key])
